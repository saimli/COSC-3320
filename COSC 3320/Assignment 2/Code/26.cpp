...
int main(int argc, char *argv[])
{
    ...
    cout << "Average Initial Insertion time: " << setprecision(5) << initial_insertion / 50.00 << " milliseconds." << endl;
    cout << "Average Insertion time: " << setprecision(5) << insertion / node.insertcount() << " milliseconds." << endl;
    cout << "Average Deletion time: " << setprecision(5) << deletion / node.deletecount() << " milliseconds." << endl;
    system("pause");
}